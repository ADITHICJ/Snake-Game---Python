...
## **How to Play**
1. Download the **SnakeGame.exe** from the release page below.  
2. Double-click the file to run the game on Windows.  
...
🎮 **Download the game here:** [Snake Game Release v1.0.0](https://github.com/ADITHICJ/Snake-Game---Python/releases/tag/v1.0.0)
